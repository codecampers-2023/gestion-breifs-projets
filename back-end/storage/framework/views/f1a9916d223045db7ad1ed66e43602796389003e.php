...
<?php endif; ?>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <a href="/register" class="ml-2 text-sm text-gray-600"><?php echo e(__('create compte')); ?></a>
            </label>
        </div>

        <a href="<?php echo e(route("google-auth")); ?>">Google</a>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\GITHUB\gestion-breifs-projets\back-end\resources\views/auth/login.blade.php ENDPATH**/ ?>