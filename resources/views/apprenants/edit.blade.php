    ...
    <div class="col-md-6 col-lg-6">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control rounded" type="text" placeholder="" value="{{ $edit->Numero_telephone }}" name="Phone">
                    @error('Phone')
                        <label style="color: red;">{{ $message }}</label>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control rounded" placeholder="" name="Etudiant_actif">
                        <option  selected value="{{ $edit->Etudiant_actif }}">{{ $edit->Etudiant_actif }} </option>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control rounded" value="{{ $edit->Date_inscription }}" type="date" placeholder=""
                ...
                <div class="form-group">
                    ...
                    <input class="form-control rounded" value="{{ $edit->Lieu_naissance }}" type="text" placeholder=""
                        name="Lieu_naissance">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control rounded" type="text" value="{{ $edit->Nom_arabe }}" placeholder=""
                        name="Nom_arabe">
                    @error('Nom_arabe')
                        <label style="color: red;">{{ $message }}</label>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input class="form-control rounded" type="text" placeholder="" value="{{ $edit->Prenom_arabe }}"
                        name="Prenom_arabe">
                    @error('Prenom_arabe')
                        <label style="color: red;">{{ $message }}</label>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input class="form-control rounded" value="{{ $edit->Date_naissance }}" type="date" placeholder=""
                        name="Date_naissance">
                    ...
                    @enderror
                          ...
                          <div class="form-group">
                                ...
                                <img src="{{ !$edit->Image ? "https://icon-library.com/images/person-head-icon/person-head-icon-27.jpg" : asset('./images/apprenant/'.$edit->Image)}}" alt="" width="80" height="80">
